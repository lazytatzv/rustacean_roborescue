...
| オペレータ ROS2 ノード | `zenoh_ope.json5` | `client` | connect quic/tcp <ROBOT_IP>:7447,17447 (→リモート zenohd) |
...
| ファイル | 場所 | 主要パラメータ |
|----------|------|----------------|
| `zenoh_ope.json5` | `operator_ws/` | mode=client, connect quic/tcp \<ROBOT_IP\>:7447,17447, no multicast |
