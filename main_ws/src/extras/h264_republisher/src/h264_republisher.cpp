...
{
 public:
  H264Republisher() : Node("h264_republisher")
  {
  ...
  void cb(const sensor_msgs::msg::CompressedImage::SharedPtr msg)
  {
    ...
    while (ret >= 0)
    {
      ...
      SwsContext *sws_ctx = sws_getContext(
          frame_->width, frame_->height, static_cast<AVPixelFormat>(frame_->format), frame_->width,
          frame_->height, AV_PIX_FMT_BGR24, SWS_BILINEAR, nullptr, nullptr, nullptr);
      if (!sws_ctx)
      {
