...
def generate_launch_description():
    ...
    world = LaunchConfiguration("world", default=os.path.join(bringup_dir, "worlds", "rescue_field.sdf"))
    ...
    pointcloud_to_laserscan = Node(
        ...
        parameters=[os.path.join(bringup_dir, "config", "pointcloud_to_laserscan.yaml"), {"use_sim_time": True}]
    )
    ...
    slam_toolbox = Node(
        ...
        name="slam_toolbox",
        parameters=[os.path.join(bringup_dir, "config", "slam_toolbox_async.yaml"), {"use_sim_time": True}],
    ...
    return LaunchDescription([
        use_sim_time_env, qt_platform,
        gz_sim, robot_state_publisher, spawn_entity, bridge,
        pointcloud_to_laserscan, odom_tf_bridge,
