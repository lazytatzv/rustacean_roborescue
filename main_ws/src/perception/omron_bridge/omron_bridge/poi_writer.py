...
class POIWriter:
    ...
    def __init__(self, out_dir: str = 'docs/outputs', team_name: str = 'Team', country: str = 'Country'):
    ...
    def add_heat_detection(self, name: str = '0', x: float = 0.0, y: float = 0.0, z: float = 0.0, robot: str = 'robot1', mode: str = 'A'):
        self.sequence += 1
        now = datetime.now().strftime('%H:%M:%S')
        row = [self.sequence, now, 'heat_sig', name, f'{x:.3f}', f'{y:.3f}', f'{z:.3f}', robot, mode]
